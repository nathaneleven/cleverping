  ...
  <Stack maxW="1272px" justify="center"  py="25px" flexDirection={["column-reverse","column-reverse","column-reverse","column-reverse","row"]}>
      <Box pb={["25px","25px","25px","25px","0"]} w={["100%","100%","100%","50%","50%"]} m="auto">
          <Box textAlign={["center","center","center","center","left"]} p={["4","5","6","7","8"]}  w={["100%","100%","100%","100%","100%"]} m="auto">
              ...
              <Link href="/internet"><Button colorScheme="orange" border="solid 3px #FF723B" color="#FF723B" size="lg" variant="outline" borderRadius="lg" py="30px">See Internet</Button></Link>
          </Box>
      </Box>

      <Flex mt="0 !important"  w={["90%","90%","90%","90%","50%"]} alignSelf="center" justify="center">
            <Image src="/cleverping/Internet-section.svg" alt="Image" />
      </Flex>
  </Stack>
    </>
    )}
